...
public class OnePoint : IDerivative
{
    ...
    public double FindFirst1D(string func, double point, double step)
    {
        ...
        return (funcToDerive(Utils.MakeDict1D(point + step)) - funcToDerive(Utils.MakeDict1D(point))) /
               step;
    }

    public double FindFirst1D(Func<Dictionary<string, double>, double> func, double point, double step)
    {
        return (func(Utils.MakeDict1D(point + step)) - func(Utils.MakeDict1D(point))) /
               step;
    }
